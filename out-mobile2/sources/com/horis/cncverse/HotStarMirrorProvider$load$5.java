...
public final class HotStarMirrorProvider$load$5 extends SuspendLambda implements Function2<TvSeriesLoadResponse, Continuation<? super Unit>, Object> {
    ...
    public HotStarMirrorProvider$load$5(String str, HotStarMirrorProvider hotStarMirrorProvider, PostData postData, List<String> list, List<ActorData> list2, String str2, int i, List<AnimeSearchResponse> list3, Continuation<? super HotStarMirrorProvider$load$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> hotStarMirrorProvider$load$5 = new HotStarMirrorProvider$load$5(this.$id, this.this$0, this.$data, this.$genre, this.$cast, this.$rating, this.$runTime, this.$suggest, continuation);
        hotStarMirrorProvider$load$5.L$0 = obj;
        return hotStarMirrorProvider$load$5;
    }
