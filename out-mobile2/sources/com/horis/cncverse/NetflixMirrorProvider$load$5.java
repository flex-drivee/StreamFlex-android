...
public final class NetflixMirrorProvider$load$5 extends SuspendLambda implements Function2<TvSeriesLoadResponse, Continuation<? super Unit>, Object> {
    ...
    public NetflixMirrorProvider$load$5(String str, NetflixMirrorProvider netflixMirrorProvider, PostData postData, List<String> list, List<ActorData> list2, String str2, int i, List<AnimeSearchResponse> list3, Continuation<? super NetflixMirrorProvider$load$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> netflixMirrorProvider$load$5 = new NetflixMirrorProvider$load$5(this.$id, this.this$0, this.$data, this.$genre, this.$cast, this.$rating, this.$runTime, this.$suggest, continuation);
        netflixMirrorProvider$load$5.L$0 = obj;
        return netflixMirrorProvider$load$5;
    }
