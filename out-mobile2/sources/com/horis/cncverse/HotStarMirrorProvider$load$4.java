...
public final class HotStarMirrorProvider$load$4 extends SuspendLambda implements Function2<Season, Continuation<? super Boolean>, Object> {
    ...
    public HotStarMirrorProvider$load$4(ArrayList<Episode> arrayList, HotStarMirrorProvider hotStarMirrorProvider, String str, String str2, Continuation<? super HotStarMirrorProvider$load$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> hotStarMirrorProvider$load$4 = new HotStarMirrorProvider$load$4(this.$episodes, this.this$0, this.$title, this.$url, continuation);
        hotStarMirrorProvider$load$4.L$0 = obj;
        return hotStarMirrorProvider$load$4;
    }
