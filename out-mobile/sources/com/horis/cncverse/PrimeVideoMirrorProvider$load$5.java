...
public final class PrimeVideoMirrorProvider$load$5 extends SuspendLambda implements Function2<TvSeriesLoadResponse, Continuation<? super Unit>, Object> {
    ...
    public PrimeVideoMirrorProvider$load$5(String str, PrimeVideoMirrorProvider primeVideoMirrorProvider, PostData postData, List<String> list, List<ActorData> list2, String str2, int i, List<AnimeSearchResponse> list3, Continuation<? super PrimeVideoMirrorProvider$load$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> primeVideoMirrorProvider$load$5 = new PrimeVideoMirrorProvider$load$5(this.$id, this.this$0, this.$data, this.$genre, this.$cast, this.$rating, this.$runTime, this.$suggest, continuation);
        primeVideoMirrorProvider$load$5.L$0 = obj;
        return primeVideoMirrorProvider$load$5;
    }
