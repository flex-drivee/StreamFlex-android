...
class DownloadEngineTest {
    ...
    fun testAes128HlsDecryption() {
        ...
        val originalData = "CINETHETA_HLS_VIDEO_SEGMENT_DATA_TEST_123456789".toByteArray(Charsets.UTF_8)
        ...
        assertEquals("CINETHETA_HLS_VIDEO_SEGMENT_DATA_TEST_123456789", String(decrypted))
    }
