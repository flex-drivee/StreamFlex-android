...
import com.cinetheta.providers.toonstream.ToonStreamSearch
import com.cinetheta.providers.toonstream.ToonStreamDetails
import com.cinetheta.extractors.toonstream.ToonStreamExtractor
...
class ToonstreamTest {
    ...
    fun testSearchAndLoad() = runBlocking {
        ...
        val firstMovie = results.firstOrNull { it.mediaType == com.cinetheta.domain.models.MediaType.MOVIE }
        val firstTv = results.firstOrNull { it.mediaType == com.cinetheta.domain.models.MediaType.TV }
