 ...
 * SecurityInterceptor
 *
 * Enforces the CineTheta security rules on every request and response,
 ...
 *
 * Exceptions thrown are caught by CineThetaHttpClient and returned as
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (scheme != "https") {
            ...
            throw SecurityException(
                "CineTheta only allows HTTPS requests. " +
                "Blocked: ${request.url}"
            )
        }
