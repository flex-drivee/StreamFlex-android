 ...
 * DomainResolver
 *
 * Resolves the active base URL for any CineTheta provider using a
 ...
 *
 * CineTheta solves this with a 5-step resolution chain. Each step is tried
...
class DomainResolver(
    ...
    private val http   : CineThetaHttpClient = CineThetaHttpClient
) {
