...
import com.cinetheta.core.network.interceptor.LoggingInterceptor
import com.cinetheta.core.network.interceptor.RefererInterceptor
import com.cinetheta.core.network.interceptor.RetryInterceptor
import com.cinetheta.core.network.interceptor.SecurityInterceptor
 ...
 * CineThetaHttpClient
 *
 * The single, authoritative HTTP client for all CineTheta network operations.
 ...
 * ```
 */
object CineThetaHttpClient {

    private const val TAG = "CineThetaHttpClient"
    ...
    private val baseClient: OkHttpClient by lazy {
        val builder = OkHttpClient.Builder()
            ...
            .addInterceptor(com.cinetheta.core.network.interceptor.CloudflareKiller()) // WebView CAPTCHA Solver

        com.cinetheta.core.network.DohProviders.applyDoh(builder).build()
    }
