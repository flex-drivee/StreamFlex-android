package com.cinetheta.app.ui.movies
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            OutlinedButton(
                                ...
                                when {
                                    movieDownloadItem?.status == com.cinetheta.domain.models.download.DownloadStatus.COMPLETED -> {
...
private fun SFSeasonSelector(
    show:             com.cinetheta.app.domain.models.Show,
    selectedSeason:   Int,
...
fun SFEpisodeItem(
    episode: Episode,
    downloadItem: com.cinetheta.domain.models.download.DownloadItem? = null,
    ...
    Row(
        ...
        Box(
            ...
            when {
                downloadItem?.status == com.cinetheta.domain.models.download.DownloadStatus.COMPLETED -> {
                    Icon(
...
@Composable
fun SFMoreLikeThis(
    items:       List<com.cinetheta.app.domain.models.SearchResult>,
...
// ─────────────────────────────────────────────────────────────────────────────
@Composable
fun SFCastList(cast: List<com.cinetheta.app.domain.models.CastMember>) {
...
// ─────────────────────────────────────────────────────────────────────────────
@Composable
fun SFTrailersCarousel(trailers: List<com.cinetheta.app.domain.models.Trailer>) {
...
// ─────────────────────────────────────────────────────────────────────────────
@Composable
fun SFProductionCompanies(companies: List<com.cinetheta.app.domain.models.ProductionCompany>) {
