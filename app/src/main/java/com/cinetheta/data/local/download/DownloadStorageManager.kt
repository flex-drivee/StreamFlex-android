package com.cinetheta.data.local.download
...
/**
 * Manages storage locations, folder structures, and disk space calculation for CineTheta downloads.
 */
class DownloadStorageManager(private val context: Context) {

    companion object {
        private const val ROOT_DIR_NAME = "CineTheta"
    ...
    fun getStorageStats(): StorageStats {
        return try {
            ...
            StorageStats(
                ...
                cineThetaUsedBytes = appUsedBytes
            )
        } catch (_: Exception) {
    ...
    data class StorageStats(
        ...
        val formattedCineThetaUsed: String
            get() = formatBytes(cineThetaUsedBytes)
