...
/**
 * Dedicated matcher for MovieBox.
 * Preserves MovieBox's tuned ranking heuristics while isolating its formulas
 * from other providers.
 */
object MovieBoxMatcher : ProviderMatcher {

    override val providerId: String = "moviebox"
