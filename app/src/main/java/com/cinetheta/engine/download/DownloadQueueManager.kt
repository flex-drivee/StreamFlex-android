...
import com.cinetheta.engine.download.service.CineThetaDownloadService
import kotlinx.coroutines.*
import java.util.concurrent.ConcurrentHashMap

/**
 * Queue and Lifecycle Manager for CineTheta downloads.
 *
 * Responsibilities:
 ...
 * - Integration with CineThetaDownloadService for foreground notifications.
 */
class DownloadQueueManager(
    ...
    fun enqueueDownload(item: DownloadItem) {
        scope.launch {
            ...
            CineThetaDownloadService.startService(context)
            processQueue()
        }
    }
    ...
    private fun processQueue() {
        scope.launch {
            ...
            if (nextItems.isEmpty() && activeJobs.isEmpty()) {
                ...
                CineThetaDownloadService.stopService(context)
                return@launch
            }
