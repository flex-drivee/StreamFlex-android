package com.cinetheta.engine.resolver
...
import com.cinetheta.extractors.ExtractorRegistry
 ...
 * ResolverEngine
 *
 * Central orchestrator for the CineTheta stream resolution pipeline (Phase 1.5).
 *
