 ...
 *
 * CineTheta solves this by treating registry.json as a remote source of truth:
...
object ExtractorRegistry {
    ...
    val DEFAULT_MANIFEST = ExtractorRegistryManifest(
        meta = RegistryMeta(
            description = "CineTheta Extractor Registry default offline manifest",
            version     = "1.0.0",
        ...
        extractors = listOf(
            ExtractorDefinition(
                ...
                headers = emptyMap(),
                androidClass = "com.cinetheta.extractors.googlevideo.GoogleVideoExtractor"
            ),
            ExtractorDefinition(
                id = "hubcloud",
                name = "HubCloud",
                ...
                androidClass = "com.cinetheta.extractors.hubcloud.HubCloudExtractor"
            ),
            ExtractorDefinition(
                id = "pixeldrain",
                name = "PixelDrain",
            ...
            ExtractorDefinition(
                ...
                androidClass = "com.cinetheta.extractors.shared.PackerExtractor"
            ),
            ExtractorDefinition(
                id = "hubdrive",
                name = "HubDrive",
                ...
                androidClass = "com.cinetheta.extractors.hubdrive.HubDriveExtractor"
            ),
            ExtractorDefinition(
                id = "hubcdn",
                name = "HubCDN",
                ...
                androidClass = "com.cinetheta.extractors.hubcdn.HubCDNExtractor"
            ),
            ExtractorDefinition(
                id = "dood",
                name = "DooD",
                ...
                androidClass = "com.cinetheta.extractors.dood.DoodExtractor"
            ),
            ExtractorDefinition(
                id = "hblinks",
                name = "HBLinks",
                ...
                androidClass = "com.cinetheta.extractors.hblinks.HBLinksExtractor"
            ),
            ExtractorDefinition(
                id = "streamtape",
                name = "StreamTape",
                ...
                androidClass = "com.cinetheta.extractors.streamtape.StreamTapeExtractor"
            ),
            ExtractorDefinition(
                id = "mixdrop",
                name = "MixDrop",
                ...
                androidClass = "com.cinetheta.extractors.mixdrop.MixDropExtractor"
            ),
            ExtractorDefinition(
                id = "redirect",
                ...
                requiresReferer = false,
                headers = emptyMap(),
                androidClass = "com.cinetheta.extractors.redirect.RedirectExtractor"
            ),
            ExtractorDefinition(
                id = "netmirror",
                name = "NetMirror",
                ...
                requiresReferer = false,
                headers = emptyMap(),
                androidClass = "com.cinetheta.extractors.netmirror.NetMirrorExtractor"
            ),
            ExtractorDefinition(
                id = "abyss",
                name = "AbyssPlayer",
                ...
                androidClass = "com.cinetheta.extractors.abyss.AbyssPlayerExtractor"
            ),
            ExtractorDefinition(
                id = "vidmoly",
                name = "Vidmoly",
                ...
                androidClass = "com.cinetheta.extractors.vidmoly.VidmolyExtractor"
            ),
            ExtractorDefinition(
                id = "streamruby",
                name = "StreamRuby",
                ...
                androidClass = "com.cinetheta.extractors.streamruby.StreamRubyExtractor"
            ),
            ExtractorDefinition(
                id = "gdmirrorbot",
                name = "GDMirrorBot",
                ...
                androidClass = "com.cinetheta.extractors.gdmirrorbot.GDMirrorBotExtractor"
            ),
            ExtractorDefinition(
                id = "cloudy",
                name = "Cloudy",
                ...
                androidClass = "com.cinetheta.extractors.cloudy.CloudyExtractor"
            ),
            ExtractorDefinition(
                id = "turbovid",
                name = "TurboVid",
                ...
                androidClass = "com.cinetheta.extractors.turbovid.TurboVidExtractor"
            ),
            ExtractorDefinition(
                id = "streamup",
                name = "StreamUp",
                ...
                androidClass = "com.cinetheta.extractors.streamup.StreamUpExtractor"
            )
        ),
    ...
    suspend fun ensureLoaded(
        ...
        http         : CineThetaHttpClient = CineThetaHttpClient,
