package com.cinetheta.extractors.hubcloud
            ...
            if (!nextHref.isNullOrBlank()) {
                ...
                if (SKIP_PATTERNS.none { lowerNext.contains(it) }) {
                    ...
                    val nextHeaders = source.headers.toMutableMap().apply { 
                        ...
                        put("User-Agent", com.cinetheta.core.constants.Constants.DEFAULT_USER_AGENT)
                    }
    ...
    private suspend fun parseHubCloud(
        ...
        for (el in buttonElements) {
            ...
            val baseHeaders = mapOf(
                "User-Agent" to com.cinetheta.core.constants.Constants.DEFAULT_USER_AGENT,
                "Accept" to "*/*"
            )
    ...
    private suspend fun resolveBuzzServer(
        ...
        return try {
            ...
            val request = RequestBuilder()
                ...
                .header("User-Agent", com.cinetheta.core.constants.Constants.DEFAULT_USER_AGENT)
